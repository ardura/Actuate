...
impl ComboBox {
    ...
    fn show_ui_dyn<'c, R>(
        ...
        ui.horizontal(|ui| {
            ...
            let mut ir = combo_box_dyn(ui, button_id, selected_text, menu_contents, icon, display_above);
...
fn combo_box_dyn<'c, R>(
    ...
    let inner = popup_below_widget(ui, popup_id, &button_response, |ui| {
        ScrollArea::vertical()
...
fn button_frame(
    ...
    // This was breaking compile for some reason - rust-analyzer bug
