use crate::{
    ...
    }, AMFilterRouting, ActuatePresetV130, FilterAlgorithms, FilterRouting, LFOController, ModulationDestination, ModulationSource, PitchRouting, PresetType, ReverbModel
};
...
pub fn load_unserialized_v126(file_data: Vec<u8>) -> ActuatePresetV130 {
...
// This takes the deserialized message pack and converts it into the latest struct
// This then attempts to return the newer preset format after
pub fn load_unserialized_v125(file_data: Vec<u8>) -> ActuatePresetV130 {
...
// This takes the deserialized message pack and converts it into the latest struct
// This then attempts to return the newer preset format after
pub fn load_unserialized_v123(file_data: Vec<u8>) -> ActuatePresetV130 {
...
// This then attempts to return the newer preset format after
pub fn load_unserialized_v114(file_data: Vec<u8>) -> ActuatePresetV130 {
...
// This takes the deserialized message pack and converts it into latest
// This then attempts to return the newer preset format after
pub fn load_unserialized_v122(file_data: Vec<u8>) -> ActuatePresetV130 {
...
// This takes the deserialized message pack and converts it into latest
// This then attempts to return the newer preset format after
pub fn load_unserialized_old(file_data: Vec<u8>) -> ActuatePresetV130 {
...
pub fn convert_preset_v126(preset: ActuatePresetV126) -> ActuatePresetV130 {
    let new_format: ActuatePresetV130 = ActuatePresetV130 {
...
// This will get cloned each time we change preset styles in actuate
pub fn convert_preset_v125(preset: ActuatePresetV125) -> ActuatePresetV130 {
    let new_format: ActuatePresetV130 = ActuatePresetV130 {
        preset_name: preset.preset_name,
        preset_info: preset.preset_info,
        preset_category: preset.preset_category,
...
// This will get cloned each time we change preset styles in actuate
pub fn convert_preset_v123(preset: ActuatePresetV123) -> ActuatePresetV130 {
    let new_format: ActuatePresetV130 = ActuatePresetV130 {
        preset_name: preset.preset_name,
        preset_info: preset.preset_info,
        preset_category: preset.preset_category,
...
// This will get cloned each time we change preset styles in actuate
fn convert_preset_v122(preset: ActuatePresetV122) -> ActuatePresetV130 {
    let new_format: ActuatePresetV130 = ActuatePresetV130 {
        preset_name: preset.preset_name,
        preset_info: preset.preset_info,
        preset_category: preset.preset_category,
...
// This will get cloned each time we change preset styles in actuate
fn convert_preset_v114(preset: ActuatePresetV114) -> ActuatePresetV130 {
    let new_format: ActuatePresetV130 = ActuatePresetV130 {
        preset_name: preset.preset_name,
        preset_info: preset.preset_info,
        preset_category: preset.preset_category,
...
// This will get cloned each time we change preset styles in actuate
fn convert_preset(preset: ActuatePresetOld) -> ActuatePresetV130 {
    let new_format: ActuatePresetV130 = ActuatePresetV130 {
        preset_name: preset.preset_name,
        preset_info: preset.preset_info,
        preset_category: preset.preset_category,
