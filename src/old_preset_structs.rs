...
pub fn load_unserialized_v130(file_data: Vec<u8>) -> ActuatePresetV131 {
    let old_unserialized: ActuatePresetV130 =
        rmp_serde::from_slice(&file_data).unwrap_or(ActuatePresetV130 {
    ...
    convert_preset_v130(old_unserialized)
}

// This takes the deserialized message pack and converts it into the latest struct
// This then attempts to return the newer preset format after
pub fn load_unserialized_v126(file_data: Vec<u8>) -> ActuatePresetV131 {
    let old_unserialized: ActuatePresetV126 =
        rmp_serde::from_slice(&file_data).unwrap_or(ActuatePresetV126 {
            preset_name: "Error Importing".to_string(),
            preset_info: "Corrupted preset or incompatible version".to_string(),
            preset_category: PresetType::Select,
            tag_acid: false,
    ...
    convert_preset_v126(old_unserialized)
}

// This takes the deserialized message pack and converts it into the latest struct
// This then attempts to return the newer preset format after
pub fn load_unserialized_v125(file_data: Vec<u8>) -> ActuatePresetV131 {
    let old_unserialized: ActuatePresetV125 =
        rmp_serde::from_slice(&file_data).unwrap_or(ActuatePresetV125 {
            preset_name: "Error Importing".to_string(),
            preset_info: "Corrupted preset or incompatible version".to_string(),
            preset_category: PresetType::Select,
            tag_acid: false,
    ...
    convert_preset_v125(old_unserialized)
}

// This takes the deserialized message pack and converts it into the latest struct
// This then attempts to return the newer preset format after
pub fn load_unserialized_v123(file_data: Vec<u8>) -> ActuatePresetV131 {
    let old_unserialized: ActuatePresetV123 =
        rmp_serde::from_slice(&file_data).unwrap_or(ActuatePresetV123 {
            preset_name: "Error Importing".to_string(),
            preset_info: "Corrupted preset or incompatible version".to_string(),
            preset_category: PresetType::Select,
            tag_acid: false,
    ...
    convert_preset_v123(old_unserialized)
}

// This takes the deserialized message pack and converts it into latest
// This then attempts to return the newer preset format after
pub fn load_unserialized_v114(file_data: Vec<u8>) -> ActuatePresetV131 {
...
// This takes the deserialized message pack and converts it into latest
// This then attempts to return the newer preset format after
pub fn load_unserialized_v122(file_data: Vec<u8>) -> ActuatePresetV131 {
    let old_unserialized: ActuatePresetV122 =
        rmp_serde::from_slice(&file_data).unwrap_or(ActuatePresetV122 {
            preset_name: "Error Importing".to_string(),
            preset_info: "Corrupted preset or incompatible version".to_string(),
            preset_category: PresetType::Select,
            tag_acid: false,
    ...
    convert_preset_v122(old_unserialized)
}

// This takes the deserialized message pack and converts it into latest
// This then attempts to return the newer preset format after
pub fn load_unserialized_old(file_data: Vec<u8>) -> ActuatePresetV131 {
    let old_unserialized: ActuatePresetOld =
        rmp_serde::from_slice(&file_data).unwrap_or(ActuatePresetOld {
            preset_name: "Error Importing".to_string(),
            preset_info: "Corrupted preset or incompatible version".to_string(),
            preset_category: PresetType::Select,
            tag_acid: false,
    ...
    convert_preset(old_unserialized)
}

// This will get cloned each time we change preset styles in actuate
pub fn convert_preset_v130(preset: ActuatePresetV130) -> ActuatePresetV131 {
    let new_format: ActuatePresetV131 = ActuatePresetV131 {
        ...
        mod3_osc_type: preset.mod3_osc_type,
...
// This will get cloned each time we change preset styles in actuate
pub fn convert_preset_v126(preset: ActuatePresetV126) -> ActuatePresetV131 {
    let new_format: ActuatePresetV131 = ActuatePresetV131 {
        preset_name: preset.preset_name,
        preset_info: preset.preset_info,
        preset_category: preset.preset_category,
...
// This will get cloned each time we change preset styles in actuate
pub fn convert_preset_v125(preset: ActuatePresetV125) -> ActuatePresetV131 {
    let new_format: ActuatePresetV131 = ActuatePresetV131 {
        preset_name: preset.preset_name,
        preset_info: preset.preset_info,
        preset_category: preset.preset_category,
...
// This will get cloned each time we change preset styles in actuate
pub fn convert_preset_v123(preset: ActuatePresetV123) -> ActuatePresetV131 {
    let new_format: ActuatePresetV131 = ActuatePresetV131 {
        preset_name: preset.preset_name,
        preset_info: preset.preset_info,
        preset_category: preset.preset_category,
        ...
        delay_type: preset.delay_type,
        use_reverb: preset.use_reverb,
        reverb_model: crate::ReverbModel::Default,
        reverb_amount: preset.reverb_amount,
        reverb_size: preset.reverb_size,
        reverb_feedback: preset.reverb_feedback,
        //1.3.0
...
// This will get cloned each time we change preset styles in actuate
fn convert_preset_v122(preset: ActuatePresetV122) -> ActuatePresetV131 {
    let new_format: ActuatePresetV131 = ActuatePresetV131 {
        preset_name: preset.preset_name,
        preset_info: preset.preset_info,
        preset_category: preset.preset_category,
        ...
        mod1_audio_module_level: preset.mod1_audio_module_level,
        // Added in 1.2.3
        mod1_audio_module_routing: crate::AMFilterRouting::Filter1,
        mod1_loaded_sample: preset.mod1_loaded_sample,
        mod1_sample_lib: preset.mod1_sample_lib,
        mod1_loop_wavetable: preset.mod1_loop_wavetable,
        mod1_single_cycle: preset.mod1_single_cycle,
        ...
        mod2_audio_module_level: preset.mod2_audio_module_level,
        // Added in 1.2.3
        mod2_audio_module_routing: crate::AMFilterRouting::Filter1,
        mod2_loaded_sample: preset.mod2_loaded_sample,
        mod2_sample_lib: preset.mod2_sample_lib,
        mod2_loop_wavetable: preset.mod2_loop_wavetable,
        mod2_single_cycle: preset.mod2_single_cycle,
        ...
        mod3_audio_module_level: preset.mod3_audio_module_level,
        // Added in 1.2.3
        mod3_audio_module_routing: crate::AMFilterRouting::Filter1,
        mod3_loaded_sample: preset.mod3_loaded_sample,
        mod3_sample_lib: preset.mod3_sample_lib,
        mod3_loop_wavetable: preset.mod3_loop_wavetable,
        mod3_single_cycle: preset.mod3_single_cycle,
...
// This will get cloned each time we change preset styles in actuate
fn convert_preset_v114(preset: ActuatePresetV114) -> ActuatePresetV131 {
    let new_format: ActuatePresetV131 = ActuatePresetV131 {
        preset_name: preset.preset_name,
        preset_info: preset.preset_info,
        preset_category: preset.preset_category,
...
// This will get cloned each time we change preset styles in actuate
fn convert_preset(preset: ActuatePresetOld) -> ActuatePresetV131 {
    let new_format: ActuatePresetV131 = ActuatePresetV131 {
        preset_name: preset.preset_name,
        preset_info: preset.preset_info,
        preset_category: preset.preset_category,
