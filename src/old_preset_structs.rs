use crate::{
    ...
    }, AMFilterRouting, ActuatePresetV126, FilterAlgorithms, FilterRouting, LFOController, ModulationDestination, ModulationSource, PitchRouting, PresetType, ReverbModel
};
...
pub fn load_unserialized_v125(file_data: Vec<u8>) -> ActuatePresetV126 {
...
// This takes the deserialized message pack and converts it into the latest struct
// This then attempts to return the newer preset format after
pub fn load_unserialized_v123(file_data: Vec<u8>) -> ActuatePresetV126 {
...
// This then attempts to return the newer preset format after
pub fn load_unserialized_v114(file_data: Vec<u8>) -> ActuatePresetV126 {
...
// This takes the deserialized message pack and converts it into latest
// This then attempts to return the newer preset format after
pub fn load_unserialized_v122(file_data: Vec<u8>) -> ActuatePresetV126 {
...
// This takes the deserialized message pack and converts it into latest
// This then attempts to return the newer preset format after
pub fn load_unserialized_old(file_data: Vec<u8>) -> ActuatePresetV126 {
...
pub fn convert_preset_v125(preset: ActuatePresetV125) -> ActuatePresetV126 {
    let new_format: ActuatePresetV126 = ActuatePresetV126 {
...
// This will get cloned each time we change preset styles in actuate
pub fn convert_preset_v123(preset: ActuatePresetV123) -> ActuatePresetV126 {
    let new_format: ActuatePresetV126 = ActuatePresetV126 {
        preset_name: preset.preset_name,
        preset_info: preset.preset_info,
        preset_category: preset.preset_category,
...
// This will get cloned each time we change preset styles in actuate
fn convert_preset_v122(preset: ActuatePresetV122) -> ActuatePresetV126 {
    let new_format: ActuatePresetV126 = ActuatePresetV126 {
        preset_name: preset.preset_name,
        preset_info: preset.preset_info,
        preset_category: preset.preset_category,
...
// This will get cloned each time we change preset styles in actuate
fn convert_preset_v114(preset: ActuatePresetV114) -> ActuatePresetV126 {
    let new_format: ActuatePresetV126 = ActuatePresetV126 {
        preset_name: preset.preset_name,
        preset_info: preset.preset_info,
        preset_category: preset.preset_category,
...
// This will get cloned each time we change preset styles in actuate
fn convert_preset(preset: ActuatePresetOld) -> ActuatePresetV126 {
    let new_format: ActuatePresetV126 = ActuatePresetV126 {
        preset_name: preset.preset_name,
        preset_info: preset.preset_info,
        preset_category: preset.preset_category,
