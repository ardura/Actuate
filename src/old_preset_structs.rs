use crate::{
    ...
    }, AMFilterRouting, ActuatePreset, FilterAlgorithms, FilterRouting, LFOController, ModulationDestination, ModulationSource, PitchRouting, PresetType
};
...
pub fn load_unserialized_v123(file_data: Vec<u8>) -> ActuatePreset {
...
// This takes the deserialized message pack and converts it into the struct from 1.1.4
// This then attempts to return the newer preset format after
pub fn load_unserialized_v122(file_data: Vec<u8>) -> ActuatePreset {
...
// This then attempts to return the newer preset format after
pub fn load_unserialized_old(file_data: Vec<u8>) -> ActuatePreset {
...
pub fn convert_preset_v123(preset: ActuatePresetV123) -> ActuatePreset {
...
// This will get cloned each time we change preset styles in actuate
fn convert_preset_v122(preset: ActuatePresetV122) -> ActuatePreset {
    let new_format: ActuatePreset = ActuatePreset {
        preset_name: preset.preset_name,
        preset_info: preset.preset_info,
        preset_category: preset.preset_category,
...
// This will get cloned each time we change preset styles in actuate
fn convert_preset_v114(preset: ActuatePresetV114) -> ActuatePreset {
    let new_format: ActuatePreset = ActuatePreset {
        preset_name: preset.preset_name,
        preset_info: preset.preset_info,
        preset_category: preset.preset_category,
